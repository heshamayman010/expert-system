# -*- coding: utf-8 -*-
"""
Created on Thu Apr 21 21:58:13 2022
...
#########################################################################
## to import fashion mnist dataset
...
#X = np.array(train_images.iloc[:, 1:])
#y = keras.utils.np_utils.to_categorical(np.array(train_images.iloc[:, 0]))
...
############################################################################
### to make the images in the gray scale 
'''
